...
export type LazyRelation<Kind extends RelationKind, ModelName extends KeyType, Dictionary extends ModelDictionary> = (modelName: ModelName, propertyPath: string, dictionary: Dictionary, db: Database<Dictionary>) => Relation<Kind, ModelName, Dictionary, any>;
export type OneOf<ModelName extends KeyType, Nullable extends boolean = false> = Relation<RelationKind.OneOf, ModelName, any, {
    nullable: Nullable;
}>;
export type ManyOf<ModelName extends KeyType, Nullable extends boolean = false> = Relation<RelationKind.ManyOf, ModelName, any, {
    nullable: Nullable;
}>;
