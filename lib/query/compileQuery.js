...
var log = (0, debug_1.debug)('compileQuery');
/**
    ...
    return function (data) {
        return Object.entries(query.where)
            ...
            return Object.entries(queryChunk).reduce(function (acc, _a) {
                ...
                if (actualValue.__type || (0, isObject_1.isObject)(actualValue)) {
                    return compileQuery({ where: queryChunk })(actualValue);
                }
                var comparatorSet = (0, getComparatorsForValue_1.getComparatorsForValue)(actualValue);
                ...
                (0, outvariant_1.invariant)(comparatorFn, 'Failed to compile the query "%j": no comparator found for the chunk "%s". Please check the validity of the query.', query, comparatorName);
