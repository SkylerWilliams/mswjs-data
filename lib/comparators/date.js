...
exports.dateComparators = {
    equals: function (expected, actual) {
        return (0, date_fns_1.compareAsc)(expected, actual) === 0;
    },
    notEquals: function (expected, actual) {
        return (0, date_fns_1.compareAsc)(expected, actual) !== 0;
    },
    gt: function (expected, actual) {
        return (0, date_fns_1.compareAsc)(actual, expected) === 1;
    },
    gte: function (expected, actual) {
        return [0, 1].includes((0, date_fns_1.compareAsc)(actual, expected));
    },
    lt: function (expected, actual) {
        return (0, date_fns_1.compareAsc)(actual, expected) === -1;
    },
    lte: function (expected, actual) {
        return [-1, 0].includes((0, date_fns_1.compareAsc)(actual, expected));
    }
};
