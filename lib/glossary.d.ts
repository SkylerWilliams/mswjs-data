...
export type ModelDefinitionValue = PrimaryKey<any> | ModelValueTypeGetter | NullableProperty<any> | NullableObject<any> | OneOf<any, boolean> | ManyOf<any, boolean> | NestedModelDefinition;
...
export type Entity<Dictionary extends ModelDictionary, ModelName extends keyof Dictionary> = PublicEntity<Dictionary, ModelName> & InternalEntityProperties<ModelName>;
export type PublicEntity<Dictionary extends ModelDictionary, ModelName extends keyof Dictionary> = Value<Dictionary[ModelName], Dictionary>;
export type RequiredExactlyOne<ObjectType, KeysType extends keyof ObjectType = keyof ObjectType> = {
...
export type DeepRequiredExactlyOne<Target extends AnyObject> = RequiredExactlyOne<{
    [Key in keyof Target]: Target[Key] extends AnyObject ? DeepRequiredExactlyOne<Target[Key]> : Target[Key];
}>;
export type InitialValues<Dictionary extends ModelDictionary, ModelName extends keyof Dictionary> = Partial<Value<Dictionary[ModelName], Dictionary>>;
export type StrictQueryReturnType<Options extends QueryOptions, ValueType extends unknown> = Options['strict'] extends true ? ValueType : ValueType | null;
...
export type UpdateManyValue<Target extends AnyObject, Dictionary extends ModelDictionary, ModelRoot extends AnyObject = Target> = Value<Target, Dictionary> | {
...
export type Value<Target extends AnyObject, Dictionary extends ModelDictionary> = {
