...
var Database = /** @class */ (function () {
    ...
    Database.prototype.generateId = function () {
        ...
        var salt = "".concat(callOrder, "-").concat(callFrame === null || callFrame === void 0 ? void 0 : callFrame.trim());
        return (0, md5_1["default"])(salt);
    };
    ...
    Database.prototype.create = function (modelName, entity, customPrimaryKey) {
        (0, outvariant_1.invariant)(entity[glossary_1.ENTITY_TYPE], 'Failed to create a new "%s" record: provided entity has no type. %j', modelName, entity);
        (0, outvariant_1.invariant)(entity[glossary_1.PRIMARY_KEY], 'Failed to create a new "%s" record: provided entity has no primary key. %j', modelName, entity);
