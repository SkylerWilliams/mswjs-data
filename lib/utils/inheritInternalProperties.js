...
function inheritInternalProperties(target, source) {
    ...
    (0, outvariant_1.invariant)(entityType, 'Failed to inherit internal properties from (%j) to (%j): provided source entity has no entity type specified.', source, target);
    (0, outvariant_1.invariant)(primaryKey, 'Failed to inherit internal properties from (%j) to (%j): provided source entity has no primary key specified.', source, target);
