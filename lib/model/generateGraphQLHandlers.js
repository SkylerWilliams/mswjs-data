...
function generateGraphQLSchema(modelName, definition, model) {
    var _a, _b;
    var pluralModelName = (0, pluralize_1["default"])(modelName);
    var capitalModelName = (0, capitalize_1.capitalize)(modelName);
    ...
    var EntityInputType = new graphql_1.GraphQLInputObjectType({
        name: "".concat(capitalModelName, "Input"),
        fields: inputFields
    });
    var EntityQueryInputType = new graphql_1.GraphQLInputObjectType({
        name: "".concat(capitalModelName, "QueryInput"),
    ...
    var objectSchema = new graphql_1.GraphQLSchema({
        ...
        mutation: new graphql_1.GraphQLObjectType({
            ...
            fields: (_b = {},
                // Create a new entity.
                _b["create".concat(capitalModelName)] = {
                    type: EntityType,
                    args: {
                ...
                _b["update".concat(capitalModelName)] = {
                    type: EntityType,
                    args: {
                        where: { type: EntityQueryInputType },
                        data: { type: EntityInputType }
                ...
                _b["update".concat((0, capitalize_1.capitalize)(pluralModelName))] = {
                    type: new graphql_1.GraphQLList(EntityType),
                    args: {
                        where: { type: EntityQueryInputType },
                        data: { type: EntityInputType }
                ...
                _b["delete".concat(capitalModelName)] = {
                    type: EntityType,
                    args: {
                        where: { type: EntityQueryInputType }
                    },
                ...
                _b["delete".concat((0, capitalize_1.capitalize)(pluralModelName))] = {
                    type: new graphql_1.GraphQLList(EntityType),
                    args: {
                        where: { type: EntityQueryInputType }
                    },
            ...
            return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 1:
                            result = _b.sent();
                            return [2 /*return*/, msw_1.HttpResponse.json(result)];
                    }
                });
            });
        }),
