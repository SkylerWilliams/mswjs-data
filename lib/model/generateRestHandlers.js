...
function createUrlBuilder(baseUrl) {
    return function (path) {
        ...
        var normalizedBaseUrl = baseUrl && baseUrl.slice(-1) === '/'
            ? baseUrl.slice(0, -1)
            : baseUrl || '';
        return "".concat(normalizedBaseUrl, "/").concat(path);
    };
}
        ...
        return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, resolver.apply(void 0, __spreadArray([], __read(args), false))];
                    case 1:
                        response = _a.sent();
...
function parseQueryParams(modelName, definition, searchParams) {
    ...
    searchParams.forEach(function (value, key) {
        ...
        if (definition[key]) {
            ...
            throw new HTTPError(HTTPErrorType.BadRequest, "Failed to query the \"".concat(modelName, "\" model: unknown property \"").concat(key, "\"."));
        }
    });
    return {
        cursor: cursor,
...
function generateRestHandlers(modelName, modelDefinition, model, baseUrl) {
    ...
    var primaryKey = (0, findPrimaryKey_1.findPrimaryKey)(modelDefinition);
    var primaryKeyValue = modelDefinition[primaryKey].getPrimaryKeyValue();
    var modelPath = (0, pluralize_1["default"])(modelName);
    ...
    return [
        ...
        msw_1.http.get(buildUrl("".concat(modelPath, "/:").concat(primaryKey)), withErrors(function (_a) {
            var _b;
        ...
        msw_1.http.put(buildUrl("".concat(modelPath, "/:").concat(primaryKey)), withErrors(function (_a) {
        ...
        msw_1.http["delete"](buildUrl("".concat(modelPath, "/:").concat(primaryKey)), withErrors(function (_a) {
            var _b;
            var params = _a.params;
            var id = extractPrimaryKey(params);
            var where = (_b = {},
