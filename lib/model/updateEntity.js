...
var log = (0, debug_1.debug)('updateEntity');
/**
...
function updateEntity(entity, data, definition) {
    ...
    var nextEntity = (0, spread_1.spread)(entity);
    (0, inheritInternalProperties_1.inheritInternalProperties)(nextEntity, entity);
    var updateRecursively = function (data, parentPath) {
        ...
        var _loop_1 = function (propertyName, value) {
            ...
            var prevValue = (0, get_1["default"])(nextEntity, propertyPath);
            ...
            var propertyDefinition = (0, getDefinition_1.getDefinition)(definition, propertyPath);
            ...
            if (propertyDefinition instanceof Relation_1.Relation) {
                ...
                var location_1 = "".concat(nextEntity[glossary_1.ENTITY_TYPE], ".").concat(propertyPath.join('.'));
                if (nextValue == null) {
                    // Forbid updating a non-nullable relationship to null.
                    (0, outvariant_1.invariant)(propertyDefinition.attributes.nullable, 'Failed to update a "%s" relationship to "%s" at "%s" (%s: "%s"): cannot update a non-nullable relationship to null.', propertyDefinition.kind, propertyDefinition.target.modelName, location_1, nextEntity[glossary_1.PRIMARY_KEY], nextEntity[nextEntity[glossary_1.PRIMARY_KEY]]);
                ...
                if (propertyDefinition.kind === Relation_1.RelationKind.ManyOf) {
                    ...
                    (0, outvariant_1.invariant)(Array.isArray(nextValue), 'Failed to update a "%s" relationship to "%s" at "%s" (%s: "%s"): expected the next value to be an array of entities but got %j.', propertyDefinition.kind, propertyDefinition.target.modelName, location_1, nextEntity[glossary_1.PRIMARY_KEY], nextEntity[nextEntity[glossary_1.PRIMARY_KEY]], nextValue);
                    nextValue.forEach(function (ref, index) {
                        // Forbid providing a compatible plain object in any array members.
                        (0, outvariant_1.invariant)(ref[glossary_1.ENTITY_TYPE], 'Failed to update a "%s" relationship to "%s" at "%s" (%s: "%s"): expected the next value at index %d to be an entity but got %j.', propertyDefinition.kind, propertyDefinition.target.modelName, location_1, nextEntity[glossary_1.PRIMARY_KEY], nextEntity[nextEntity[glossary_1.PRIMARY_KEY]], index, ref);
                        // Forbid referencing a different model in any array members.
                        (0, outvariant_1.invariant)(ref[glossary_1.ENTITY_TYPE] === propertyDefinition.target.modelName, 'Failed to update a "%s" relationship to "%s" at "%s" (%s: "%s"): expected the next value at index %d to reference a "%s" but got "%s".', propertyDefinition.kind, propertyDefinition.target.modelName, location_1, nextEntity[glossary_1.PRIMARY_KEY], nextEntity[nextEntity[glossary_1.PRIMARY_KEY]], index, propertyDefinition.target.modelName, ref[glossary_1.ENTITY_TYPE]);
                    });
                    propertyDefinition.resolveWith(nextEntity, nextValue);
                    return "continue";
                }
                // Forbid updating a relationship with a compatible plain object.
                (0, outvariant_1.invariant)(nextValue[glossary_1.ENTITY_TYPE], 'Failed to update a "%s" relationship to "%s" at "%s" (%s: "%s"): expected the next value to be an entity but got %j.', propertyDefinition.kind, propertyDefinition.target.modelName, location_1, nextEntity[glossary_1.PRIMARY_KEY], nextEntity[nextEntity[glossary_1.PRIMARY_KEY]], nextValue);
                // Forbid updating a relationship to an entity of a different model.
                (0, outvariant_1.invariant)(nextValue[glossary_1.ENTITY_TYPE] == propertyDefinition.target.modelName, 'Failed to update a "%s" relationship to "%s" at "%s" (%s: "%s"): expected the next value to reference a "%s" but got "%s" (%s: "%s").', propertyDefinition.kind, propertyDefinition.target.modelName, location_1, nextEntity[glossary_1.PRIMARY_KEY], nextEntity[nextEntity[glossary_1.PRIMARY_KEY]], propertyDefinition.target.modelName, nextValue[glossary_1.ENTITY_TYPE], nextValue[glossary_1.PRIMARY_KEY], nextValue[nextValue[glossary_1.PRIMARY_KEY]]);
            ...
            (0, set_1["default"])(nextEntity, propertyPath, nextValue);
        };
        try {
